...
function CreateWorkspace() {
    const [coverImage,setCoverImage]=useState('/coverImages/image7.jpg');
    ...
    <div className="p-10 md:px-36 lg:px-64 xl:px-96 py-28">
      <div className="shadow-2xl rounded-xl">
        ...
        <CoverPicker setNewCover={(v) => setCoverImage(v)}>
          <div className="relative group cursor-pointer">
            ...
            <div className="group-hover:opacity-40">
              <Image src={coverImage} width={400} height={400} className="w-full h-[180px] object-cover rounded-t-xl" alt=""/>
            </div>
          </div>
        </CoverPicker>
        ...
        <div className="p-12">
          ...
          <h2 className="text-sm mt-2"> This is a shared space where you can collaborate wth your team. You can always rename it later.</h2>
